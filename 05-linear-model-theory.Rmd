...
**Note for JF:** standardized format for Lemmas? Also, I'm putting lemmas be3fore the Proof section.
...
**NOTE FOR JF**: I typed up the following result but I see it doesn't belong it this proof section. Please review if we want to remove it or add a little section header.
