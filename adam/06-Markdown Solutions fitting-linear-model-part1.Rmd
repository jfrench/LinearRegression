...
- $\widehat{\beta}_0$ is the vertical intercept of the line of best fit. Practically speaking, it is the predicted bill length of a penguin that has a body mass of 0 grams. In this context, $\widehat{\beta}_0$ does not make practical sense since no penguin has a body mass of 0 grams.

- $\widehat{\beta}_1$ is the slope of the line of best fit. For each additional 1 gram of body mass, the bill length is predicted to increase by 0.00405 mm.
