...
Another option is the `glimpse` function from the `dplyr` package. This function behaves similarly to `str` but it additionally formats the output to your console.
