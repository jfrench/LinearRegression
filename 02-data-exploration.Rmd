...
Another option is the `glimpse` function from the `dplyr` package. This function behaves similarly to `str`, but it automatically formats the output to your console and some find it more readable.
