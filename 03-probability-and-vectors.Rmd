...
A random variable $Y\sim \mathrm{Bernoulli}(\theta) with $\Omega = {0, 1}$ and $P(Y=1)=\theta$.
...
<!-- A random variable Y∼Bin(n,θ) is the sum of n≥1 (fixed) independent Bernoulli random variables. The associated support is S={0,1,2,…,n} and the pmf is p(y│θ)=(■(n@y)) θ^y (1-θ)^(n-y). -->
...
<!-- Assume Y∼Bin(20,0.4). Determine F(8) and P(8≤Y≤10).  -->
<!-- Poisson Distribution -->

<!-- Y∼Poisson(θ) when S={0,1,2,…} and p(y|θ)=1/y! θ^y e^(-θ). -->
...
<!-- Assume Y∼Poisson(4). Determine F(12) and P(15≤Y≤20). -->
