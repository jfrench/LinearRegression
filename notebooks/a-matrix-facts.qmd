...
|  $y^2$  |        $2y$        |
| $c y^2$ |       $2cy$        |
: Some basic calculus results for scalar functions taking scalar inputs. {#tbl-deriv-scalar}
:::
...
: Some basic calculus results for scalar functions taking vector inputs. {#tbl-deriv-vector}
:::

Comparing Tables @tbl-deriv-scalar and @tbl-deriv-vector, we can make parallels with the derivative results from the two contexts.
