...
knitr::kable(
  data.frame(
    "Regression Model"=c("Simple Linear", "Multiple"),
    "Intercept Coef."=c(26.9, -3.44),
    "Body Mass Coef."=c(0.004,0.0007),
    check.names = F
  )
)
```
...
`body_mass_g` alone, which we already considered. Examining the leverage plot for the interaction term `body_mass_g:species` , we see the points have only a
