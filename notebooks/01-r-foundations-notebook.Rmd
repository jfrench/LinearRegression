...
-   `factor` objects aren't technically vectors (e.g., running `is.factor(f2)` based on the above code will return `TRUE`) though they essentially behave like vectors, which is why they are included here.
