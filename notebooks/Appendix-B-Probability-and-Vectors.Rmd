...
We review some basic probability-related terminology,
...
- **Outcomes**, aka **points**, **realizations**, or **elements**.
- $\Omega$: set of outcomes, composed of **elements**.
...
\[\mathrm{var}(X)=2/5-(2/9)^2=\frac{142}{405}\]
\[\mathrm{var}(Y)=4/5-(2/3)^2=\frac{16}{45}\]
