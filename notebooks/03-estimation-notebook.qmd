...
We build a **regression model** using observed values of the available variables using $n$ observations sampled from a population.
...
The **response variable** is the outcome variable we are trying to predict.

- They are also called **outcome**, **output**, or **dependent** variables.
