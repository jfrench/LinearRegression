---
title: "Lecture 01 - R Foundations"
author: "CU Denver"
output:
...
The **faraway** package contains data and some useful functions we will be using later in the course. 

```{r, eval=FALSE}
install.packages("faraway")
```

After you install **faraway**, load the package by running the command below.
