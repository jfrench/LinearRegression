...
R statistical software is popular for data analysis in:

* academia
* industry
* government

We will lay a basic foundation of R knowledge and skills in this module.

## What is R?

R is:

* A programming language and environment designed for statistical computing. 
* Free, open source, and runs on many different types of computers.
* An interactive programming language.
* Highly extendable through packages and writing your own functions.

## Installing R

Download an installer program from the R Project's website [(https://www.r-project.org/)](https://www.r-project.org/) from [https://cloud.r-project.org/](https://cloud.r-project.org/). 

* A stable link for the most current installer program is available at [https://cloud.r-project.org/bin/windows/base/release.html](https://cloud.r-project.org/bin/windows/base/release.html).
* Similar links are not currently available for Mac and Linux computers.

## Installing R Studio

R Studio Desktop is a free "front end" for R provided by R Studio [(https://rstudio.com/)](https://rstudio.com/). 

R Studio Desktop makes doing data analysis with R much easier by adding an Integrated Development Environment (IDE) and providing many other features. 

Download R Studio at [https://rstudio.com/products/rstudio/download/](https://rstudio.com/products/rstudio/download/). 
...
<!-- ![General options.](pictures/general_options.png) -->
<!-- ``` -->
...
<!-- 1. Highlight the code you want to run and click the ![Run button](pictures/run_button.png).
