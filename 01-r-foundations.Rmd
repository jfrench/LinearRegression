...
To turn off this feature, in the RStudio menu bar click Tools &rarr; Global Options and then make sure the "General" option is selected. Then make the following changes (if necessary):
...
- Clicking File &rarr; New File &rarr; R Script in the RStudio menu bar.
...
- Click File &rarr; Save in the RStudio menu bar.
