...
Interpreting a fitted model is a critical part of a regression analysis. These interpretations generally describe the roles and impact each variable plays in predicting the behavior of the response variable.
...
An effect plot is a visual display that aids in helping us intuitively interpret the effect of a *predictor* in a model.
