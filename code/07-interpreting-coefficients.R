...
# the correlation between WT2 and DW9 and DW18 is now minimal.  Practically, we've separted the effect of WT2, the weight gain between 2 and 9, and between 9 and 18.
scatterplotMatrix(~ BMI18 + WT2 + DW9 + DW18, BGSgirls)
